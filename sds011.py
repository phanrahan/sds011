...
if __name__ == "__main__":
    ...
    sensor = SDS011("//dev/cu.usbserial-14110", use_query_mode=True)
    if sensor:
        print('pm25, pm10, aqi_pm25')
        while 1:
            pm25, pm10 = sensor.query()  # Gets (pm25, pm10)
            print(pm25, pm10, aqi.to_iaqi(aqi.POLLUTANT_PM25, pm25, algo=aqi.ALGO_EPA))
            sleep(1)
